...
import myPhoto from "../../../assets/port2-removebg-preview.png";
  ...
  return (
    <section className="pt-28" data-aos="fade-right">
      ...
      >
        ...
        <div className="md:absolute md:top-[50%] md:translate-y-[-59%] md:left-0 md:h-[455px] md:w-[60%] sm:bg-altBgMedium lg:dark:bg-darkBgLight md:py-36 lg:py-44 ">
          {/* Qoute Icon👇 */}
