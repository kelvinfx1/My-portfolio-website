...
function Portfolio() {
  ...
  return (
    ...
    >
      {/* Floating text 👇*/}
      <p className="hidden lg:block absolute top-80 -left-36 rotate-90 text-7xl font-semibold italic opacity-5 ">
        Portfolio
      </p>
      {/* Floating text ☝*/}
          ...
          <div className="w-full shadow-2xl lg:shadow-none" data-aos="fade-up">
            ...
            <div className="text-textMedium px-3 py-5 lg:text-end lg:absolute lg:pl-10 lg:top-24 lg:right-0 lg:rounded-md lg:w-[40%] xl:right-36 2xl:right-60 3xl:right-80">
              <div className="">
                ...
                <p className="my-2 lg:bg-altBgMedium lg:font-medium lg:shadow-lg lg:py-3 rounded-md lg:rounded-md lg:pr-6 2xl:pr-3">
                  {project.description}
                </p>
              </div>
